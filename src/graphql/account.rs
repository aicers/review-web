...
impl AccountMutation {
    ...
    async fn insert_account(
        ...
        if customer_ids.is_none() && role != Role::SystemAdministrator {
            return Err("You must provide at least one customer id to insert an account that is not in the System Administrator role.".into());
        }
    ...
    async fn update_account(
        ...
        if role.is_some() || customer_ids.is_some() {
            ...
            {
                return Err("You must provide at least one customer id to update an account that is not in the System Administrator role.".into());
            }
        }
...
mod tests {
    ...
    async fn insert_account() {
        ...
        assert_eq!(
            ...
            "You must provide at least one customer id to insert an account that is not in the System Administrator role."
        );
    ...
    async fn update_account() {
        ...
        assert_eq!(
            res.errors.first().unwrap().message,
            "You must provide at least one customer id to update an account that is not in the System Administrator role."
        );
